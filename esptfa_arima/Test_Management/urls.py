...
router.register(
    r"analysis-document", AnalysisDocumentViewSet, basename="analysis-document"
)
...
router.register(
    r"teacher-assignment", TeacherAssignmentViewSet, basename="teacher-assignment"
)

router.register(
    r"analysis-document-statistic",
    AnalysisDocumentStatisticViewSet,
    basename="analysis-document-statistic",
)
router.register(
    r"formative-assessment-statistic",
    FormativeAssessmentStatisticViewSet,
    basename="formative-assessment-statistic",
)
router.register(
    r"student-scores-statistic",
    StudentScoresStatisticViewSet,
    basename="student-scores-statistic",
)
...
router.register(r"analysis-group", AnalysisGroupViewSet, basename="analysis-group")
